...
const botoes = document.querySelectorAll(".botao"); /*uma variável constante que pega todos os elementos da classe botao*/


//Objetivo 1 passo 1 - pegar os personagens no JS pra poder mostrar ou esconder ele
